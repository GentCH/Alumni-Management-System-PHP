...
<div class="forgot_wrapper">
	<div class="forgot_container">
		...
		<form class="forgot_form" method="post">
			<input type="text" placeholder="User ID" name="forgot_userid">
...
if(isset($_POST['retrieve']))
{
	...
	$sql = "SELECT al_id FROM alumniinfo WHERE al_id='$id' AND pi_email='$email'";
	...
	{
		$temp=$row['al_id'];
		$sql2 = "SELECT al_password FROM alumnimember WHERE al_id='$temp'";
	...
	{
		echo "<script>alert('ERROR: Please contact our administrator to retrieve your password.')</script>";
	}
}
?>
</html>