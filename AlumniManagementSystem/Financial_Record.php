...
<?php
$sqlshow2= "SELECT financialdata.payment_id, alumniinfo.pi_full_name, financialdata.payment_purpose, financialdata.payment_date, financialdata.total_payment FROM alumniinfo, financialdata
			WHERE alumniinfo.al_id = financialdata.al_id";
