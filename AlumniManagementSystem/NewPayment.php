...
<tr>
<th align="left" width="450" style="border:hidden;font-size:18px">Alumni ID: </th>
...
<td width="450" style="border:hidden"><input class="i1" type="date" name="pd"></td>
</tr>
<tr>
<th align="left" width="450" style="border:hidden;font-size:18px">Payment Paid: </th>
<td width="450" style="border:hidden"><input size="45" type="text" name="ppaid"></td>
</tr>
...
if(isset($_POST['addpayment']))
{
	...
	{
		$sql1 = "INSERT INTO financialdata (payment_id, total_payment, payment_purpose, payment_date, al_id) VALUES('$paymentid', '$paymentpaid', '$paymentpurpose', '$paymentdate', '$alid')";
		if ($paymentpurpose=='Registration Fee')
		{
		$sql2= "UPDATE alumniinfo SET pi_membership_status = 'PAID' WHERE al_id = '$alid'";
		$result5 = $conn->query($sql2);
		echo "<br /><p class=p1>*****Payment successfully inserted & Membership status is updated..*****</p>";
